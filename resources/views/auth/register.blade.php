    ...
    <div class="container mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center mb-4">{{ __('Register') }}</h5>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="job" class="form-control" type="text" name="job" :value="old('job')" required autofocus autocomplete="job" />
